...
# Import email settings from a separate file
...
SECRET_KEY = 'django-insecure-tjk2dg+v(gcvtz0veeprxco9^ud!@*t*u93y2df@kg$8bkx+54'
...
TEMPLATES = [
    {
        ...
        # Use a single directory for all templates
...
AUTH_PASSWORD_VALIDATORS = [
    # Django default password validators
    {
